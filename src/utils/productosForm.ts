...
export const ProductoValidate = yup.object().shape({
    ...
    precio_venta_usd: yup.string().trim().matches(/^[0-9.]+$/, "Ingrese solo numeros // Los decimales se separan con un punto").max(15, "El precio de venta no puede superar los 15 caracteres"),
    stock: yup.string(),
